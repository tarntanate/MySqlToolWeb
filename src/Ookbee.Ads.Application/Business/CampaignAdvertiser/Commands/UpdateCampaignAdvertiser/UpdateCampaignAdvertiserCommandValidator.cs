...
{
    public class UpdateCampaignAdvertiserCommandValidator : AbstractValidator<UpdateCampaignAdvertiserCommand>
    {
        public UpdateCampaignAdvertiserCommandValidator()
        {
