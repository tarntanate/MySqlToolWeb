...
{
    public class CreateCampaignAdvertiserCommandValidator : AbstractValidator<CreateCampaignAdvertiserCommand>
    {
        public CreateCampaignAdvertiserCommandValidator()
        {
