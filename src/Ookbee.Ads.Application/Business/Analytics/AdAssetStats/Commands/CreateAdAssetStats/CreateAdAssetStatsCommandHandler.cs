...
{
    public class CreateAdAssetStatsCommandHandler : IRequestHandler<CreateAdAssetStatsCommand, HttpResult<long>>
    {
        private IMapper Mapper { get; }
        private AnalyticsDbRepository<AdStatsEntity> AdStatsDbRepo { get; }

        public CreateAdAssetStatsCommandHandler(
            IMapper mapper,
        ...
        public async Task<HttpResult<long>> Handle(CreateAdAssetStatsCommand request, CancellationToken cancellationToken)
        {
