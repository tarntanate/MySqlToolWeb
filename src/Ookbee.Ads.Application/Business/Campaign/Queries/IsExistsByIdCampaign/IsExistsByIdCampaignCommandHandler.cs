...
{
    public class IsExistsByIdCampaignCommandHandler : IRequestHandler<IsExistsByIdCampaignCommand, HttpResult<bool>>
    {
        private OokbeeAdsMongoDBRepository<CampaignDocument> CampaignDocument { get; }

        public IsExistsByIdCampaignCommandHandler(OokbeeAdsMongoDBRepository<CampaignDocument> campaignDocument)
        {
            CampaignDocument = campaignDocument;
        }

        public async Task<HttpResult<bool>> Handle(IsExistsByIdCampaignCommand request, CancellationToken cancellationToken)
        {
