...
{
    public class GetAdImpressionReportByAdIdHandler : IRequestHandler<GetAdImpressionReportByAdIdQuery, Response<List<AdImpressionReportDto>>>
    {
        ...
        public async Task<Response<List<AdImpressionReportDto>>> Handle(GetAdImpressionReportByAdIdQuery request, CancellationToken cancellationToken)
        {
